...
The functions and constants are re-exported from `next_prompt_legacy` while the
split is performed incrementally. New code should import from this module rather
than the legacy monolith.
"""
